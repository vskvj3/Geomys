...
type ReplicationServiceClient interface {
	...
	ReplicateRequest(ctx context.Context, in *CommandRequest, opts ...grpc.CallOption) (*ReplicationAck, error)
...
func (c *replicationServiceClient) ReplicateRequest(ctx context.Context, in *CommandRequest, opts ...grpc.CallOption) (*ReplicationAck, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ReplicationServiceServer interface {
	...
	// Leader → Followers (Replicate Write Requests)
	ReplicateRequest(context.Context, *CommandRequest) (*ReplicationAck, error)
	// Follower → Leader (Sync on Restart)
...
func (UnimplementedReplicationServiceServer) ReplicateRequest(context.Context, *CommandRequest) (*ReplicationAck, error) {
...
func _ReplicationService_ReplicateRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicationServiceServer).ReplicateRequest(ctx, req.(*CommandRequest))
	}
	return interceptor(ctx, in, info, handler)
}
